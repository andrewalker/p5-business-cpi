...
payments are completed, or fail. Using CPI, the only thing you need to do is
hand the request to C<< $cpi->notify() >>.

You can save the notification url used in your app when building the CPI
object, like this:
